...
noise = 1
koff = 0.3
params = [c, nu_pr, nu_cb, k, noise, koff]

save_path = '/Users/elizabethdavis/Desktop/Models/1D_CellSpringModel/figures/dirmig_manycells'
